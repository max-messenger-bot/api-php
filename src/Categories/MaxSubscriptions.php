...
use MaxMessenger\Api\Models\Request\Subscriptions\DeleteSubscriptions;
use MaxMessenger\Api\Models\Request\Subscriptions\GetUpdates;
use MaxMessenger\Api\Models\Request\Subscriptions\PostSubscriptions;
use MaxMessenger\Api\Models\Response\Shared\Result;
use MaxMessenger\Api\Models\Response\Subscriptions\Subscriptions;
...
final class MaxSubscriptions
{
    ...
    {
        return new Subscriptions($this->get('/subscriptions'));
    }
    ...
    public function getUpdates(?int $limit, ?int $timeout, ?int $marker, ?array $types): Subscriptions
    {
        ...
        return new Subscriptions($this->get('/updates', $request));
    }
    ...
    public function subscribe(string $url, ?array $updateTypes): Result
    {
        ...
        return new Result($this->post('/subscriptions', $request));
    }
    ...
    public function unsubscribe(string $url): Result
    {
        ...
        return new Result($this->delete('/subscriptions', $request));
    }
}
